...
export const reportQueryValidator = z.object({
    query:z.object({
        entry:z.string().min(6,{message: "el nombre del oficial no puede tener menos de 6 caracteres"}).max(60, {message:"el nombre del oficial no puede exceder los 60 caracteres"}).optional(),
